...
func TestGetNonExistedntProduct(t *testing.T) {
	clearTable()
	...
	if m["error"] != "Product not found" {
		t.Errorf("Expected the 'error' key of the response to"+
			"'Product not found'. got '%s'", m["error"])
	}
}
...
func TestCreateProduct(t *testing.T) {
	...
	// the id is compared to 1.0 because JSON unmarshaling convers
...
func TestUpdateProduct(t *testing.T) {
	...
	if m["proce"] == originalProduct["price"] {
